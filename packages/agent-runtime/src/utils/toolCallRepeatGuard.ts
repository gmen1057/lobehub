...
/** User-visible stop when the same tool+args is requested TOOL_CALL_REPEAT_LIMIT times in a row. */
export const TOOL_CALL_REPEAT_STOP_MESSAGE = `Остановил: один и тот же инструмент вызван ${TOOL_CALL_REPEAT_LIMIT} раз подряд с теми же данными.`;
