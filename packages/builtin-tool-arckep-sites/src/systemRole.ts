...
5. Dashboards publish open, exactly like any other site — no password is generated or required. After publishing, give the user the address and mention that the site can be closed with a password anytime via the «Доступ по паролю» toggle on their site card in «Мои сайты» on arckep.ru.
</dashboard>
