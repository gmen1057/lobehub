...
const MainMenu = memo(() => {
  ...
  return (
    <>
      ...
      {/* arckep: upstream "About" group (Contact us / Submit issue / Star on GitHub /
          Discord community) all removed — they point to LobeHub feedback form and
          LobeHub socials which aren't relevant for our users. */}
    </>
  );
});
