...
import { BrainCircuit, Cloudy, HardDriveDownload, LogOut, Settings2, Sparkles } from 'lucide-react';
...
export const useMenu = () => {
  ...
  // arckep: LobeHub desktop app download removed — links to lobehub.com
  // which isn't our distribution channel. We're a web-only product.
  ...
  const mainItems = [
    {
      ...
      key: 'studio',
      label: <a href="https://arckep.ru/studio">В Студию</a>,
    },
    {
      type: 'divider',
    },
