export default {
  ...
  'channel.dmPolicy': 'Who can use this bot',
  'channel.dmPolicyHint':
    'Selected users (default): you plus people you grant access to — starts as just you. Everyone: anyone who messages the bot (you pay for all usage). Paused: no end-users are served (you can still use it yourself).',
  'channel.dmPolicyAllowlist': 'Selected users',
  'channel.dmPolicyDisabled': 'Paused (no one)',
  'channel.dmPolicyOpen': 'Everyone',
