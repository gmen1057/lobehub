export default {
  ...
  'artifact.truncated':
    'Response was cut off — the artifact is incomplete. Regenerate the message.',
  ...
  'shareModal.attachSpreadsheet': 'Attach XLSX to Chat',
  'shareModal.attachSpreadsheetError': 'Failed to attach XLSX',
  'shareModal.attachSpreadsheetSuccess': 'XLSX attached to chat',
